...
else
{
		echo "\e[92m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";	
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
		echo "\e[92m[🚫]        \e[91mYEH GA PUNYA AKUNNYA 😆    \e[92m [🚫]\n";
	        echo "\e[92m[🚫]              \e[91m⚠️ WARNING ⚠️           \e[92m [🚫]\n";
		echo "\e[92m[🚫]           \e[91mSEGERA MINTA IZIN          \e[92m [🚫]\n";
	        echo "\e[92m[🚫]          \e[91mFACEBOOK DWI IRFAN     \e[92m [🚫]\n";
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
goto login;
}
	return rtrim( $input, "\n" );
ulang:
echo "\n";
echo "\e[92m             (HALLO MAS $input THANKS UDAH PAKAI SC INI)               \n";
echo "\e[89m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
// function change(){
        $nama = nama();
        ...
        echo color("yellow","📶▶️ KODE OTP UDAH GUA TERBANGIN TOD")."\n";
        otp:
	...
	gocar:
        echo "\n".color("green","🔐▶️ INI VOC 15.10.5 CUK ");
        echo "\n".color("yellow","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(20);
        ...
        echo "\n".color("red","🔐▶️ Message: ".$message);
        gofood:
        echo "\n".color("green","🔐▶️ INI VOC GOSEND CUK");
        echo "\n".color("yellow","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("blue",".");
        sleep(5);
        ...
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("red","🔓▶️ Message: ".$message);
        echo "\n".color("green","🔐▶️ INI VOC REFRESH FOOD CUK");
        echo "\n".color("yellow","⏳▶️ Please wait");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(5);
	...
	$post = [
         ...
         echo color("red","-] NOMOR LO GA FRESH KAMBING");
         echo"\n▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n\n";
         echo color("yellow","!] MASUKAN YG FRESH BOSOK\n");
         goto ulang;
         }
//  }
